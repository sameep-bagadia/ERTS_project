...
class Target:
	...
	def run(self):
		...
		while True:
			...
			# moving_boxes = get_moving_areas(bounding_box_list, frame_size)
			# print moving_boxes
			# centroid = get_centroid(moving_boxes)
			# print "the centroid of the moving people is: ", centroid
			...
			# print 'center points= ',trimmed_center_points
			...
			#find centroid for these points now
...
def detector(cap):
	...
	while(1):
		...
		if ret:
			...
			lower_blue = np.array([120, 60, 60], dtype=np.uint8)
	        ...
	        # for cd, value in np.ndenumerate(res):
	        #     if value >0:
	        #         sum_x = sum_x + cd[0]
	        #         sum_y = sum_y + cd[1]
	        ...
	        #     print it
	        #     if -1>0:
	        #         sum_x = sum_x + it.multi_index[0]
	        #         sum_y = sum_y + it.multi_index[1]
	        #         number_matches = number_matches + 1
	        #     it.iternext()

	        # for idx in np.ndindex(*res.shape[:2]):
	        #     data = res[idx]
	        #     if data[0]>0:
	        #         c = 1
