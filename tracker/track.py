...
# 	x_sum = 0
# 	y_sum = 0
# 	print 'moving_points= ',moving_points
# 	for i in range(numb_points):
# 		print 'i = ',i
# 		xleft = moving_points[i][0][0]
# 		yleft = moving_points[i][0][1]
# 		xright = moving_points[i][1][0]
# 		yright = moving_points[i][1][1]
# 		x_sum = x_sum + (xleft+xright)/2
# 		y_sum = y_sum + (yleft+yright)/2
# 	if numb_points == 0:
# 		return [1,1]
